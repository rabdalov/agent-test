...
| 36       | Доработка ChorusDetector                                           | ⏳ Не начата	| 🔲    |
...
| 43       | Рефакторинг VolumeSegment и универсальный merge_segments          | ⏳ Не начата | 🔲      |
...
- [ ] **Итерация 15 — Полировка UX и инфраструктуры**
  - Улучшение сообщений пользователю, базовое логирование, документация по запуску (локально и Docker)
...
- [ ] **Итерация 43 — Рефакторинг VolumeSegment и универсальный merge_segments**
