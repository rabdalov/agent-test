...
class AlignmentService:
    ...
    def align_timestamps(
        ...
        Args:
            ...
            max_word_time:           Maximum allowed duration (seconds) for
                                     the first word of a line; exceeding this
                                     triggers gap-marker insertion.
            normal_word_time:        Expected/normal duration (seconds) used
                                     to recompute ``start_time`` of the first
                                     real word when a gap is detected.
